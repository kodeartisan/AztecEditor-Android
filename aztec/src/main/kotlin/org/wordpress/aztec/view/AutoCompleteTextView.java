 ...
 */
public class AutoCompleteTextView extends AztecText implements Filter.FilterListener {
    ...
    public AutoCompleteTextView(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        final int popupWidth = pa.getLayoutDimension(
                R.styleable.AutoCompleteTextView_dropDownWidth, ViewGroup.LayoutParams.WRAP_CONTENT);
        final int popupHeight = pa.getLayoutDimension(
                R.styleable.AutoCompleteTextView_dropDownHeight, ViewGroup.LayoutParams.WRAP_CONTENT);
     ...
     */
    public void setOnDismissListener(final android.widget.AutoCompleteTextView.OnDismissListener dismissListener) {
     ...
     * @see android.widget.AutoCompleteTextView#setOnDismissListener(android.widget.AutoCompleteTextView.OnDismissListener)
     */
    ...
    private static class PopupDataSetObserver extends DataSetObserver {
        private final WeakReference<android.widget.AutoCompleteTextView> mViewReference;

        private PopupDataSetObserver(android.widget.AutoCompleteTextView view) {
            mViewReference = new WeakReference<android.widget.AutoCompleteTextView>(view);
        }

        @Override
        public void onChanged() {
            final android.widget.AutoCompleteTextView textView = mViewReference.get();
