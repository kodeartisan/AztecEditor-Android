...
import org.wordpress.aztec.model.Element
import org.wordpress.aztec.model.ElementNode
import org.wordpress.aztec.spans.*
import java.util.*

class SpanModelParser {
    ...
    fun toSpanned(root: ElementNode) : Spanned {
        val spannable = SpannableStringBuilder()
        root.toSpanned(spannable)
        return spannable
    }

    fun fromSpanned(text: Spanned) : ElementNode {
